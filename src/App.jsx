...
import './App.css'; // <--- THIS CONNECTS YOUR CSS
...
function App() {
  ...
  return (
    // Changed 'style' to 'className' to use your aesthetic CSS
    <div className="app-container"> 
      ...
      {/* Requirement: Conditional Rendering [1] */}
      {isGoalReached && (
      ...
      <div className="input-section">
        ...
        />
        {/* Requirement: Live display of typed message [1] */}
